...
import { CommonConfirmModalProps } from "@imymemind/core/components/modelViews/CommonConfirmModal";
...
const DownloadButtonGroup = ({
  ...
  const { onOpen } = useTypeSafeModal<CommonConfirmModalProps>();
